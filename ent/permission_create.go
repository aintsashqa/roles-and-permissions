...
func (pc *PermissionCreate) SetCreationDate(t time.Time) *PermissionCreate {
	pc.mutation.SetCreationDate(t)
	return pc
}

// SetNillableCreationDate sets the "creation_date" field if the given value is not nil.
func (pc *PermissionCreate) SetNillableCreationDate(t *time.Time) *PermissionCreate {
	if t != nil {
		pc.SetCreationDate(*t)
	}
	return pc
}

// SetLastUpdateDate sets the "last_update_date" field.
func (pc *PermissionCreate) SetLastUpdateDate(t time.Time) *PermissionCreate {
	pc.mutation.SetLastUpdateDate(t)
	return pc
}

// SetNillableLastUpdateDate sets the "last_update_date" field if the given value is not nil.
func (pc *PermissionCreate) SetNillableLastUpdateDate(t *time.Time) *PermissionCreate {
	if t != nil {
		pc.SetLastUpdateDate(*t)
	}
	return pc
}

// SetMarkAsDeleteDate sets the "mark_as_delete_date" field.
func (pc *PermissionCreate) SetMarkAsDeleteDate(t time.Time) *PermissionCreate {
	pc.mutation.SetMarkAsDeleteDate(t)
	return pc
}

// SetNillableMarkAsDeleteDate sets the "mark_as_delete_date" field if the given value is not nil.
func (pc *PermissionCreate) SetNillableMarkAsDeleteDate(t *time.Time) *PermissionCreate {
	if t != nil {
		pc.SetMarkAsDeleteDate(*t)
	}
	return pc
}
...
func (pc *PermissionCreate) defaults() {
	if _, ok := pc.mutation.CreationDate(); !ok {
		v := permission.DefaultCreationDate()
		pc.mutation.SetCreationDate(v)
	}
	if _, ok := pc.mutation.LastUpdateDate(); !ok {
		v := permission.DefaultLastUpdateDate()
		pc.mutation.SetLastUpdateDate(v)
	}
...
func (pc *PermissionCreate) check() error {
	...
	if _, ok := pc.mutation.CreationDate(); !ok {
		return &ValidationError{Name: "creation_date", err: errors.New(`ent: missing required field "Permission.creation_date"`)}
	}
	if _, ok := pc.mutation.LastUpdateDate(); !ok {
		return &ValidationError{Name: "last_update_date", err: errors.New(`ent: missing required field "Permission.last_update_date"`)}
	}
	return nil
}
...
func (pc *PermissionCreate) createSpec() (*Permission, *sqlgraph.CreateSpec) {
	...
	if value, ok := pc.mutation.CreationDate(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
			Column: permission.FieldCreationDate,
		})
		_node.CreationDate = value
	}
	if value, ok := pc.mutation.LastUpdateDate(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
	...
	if value, ok := pc.mutation.MarkAsDeleteDate(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
