...
func (pu *PermissionUpdate) SetLastUpdateDate(t time.Time) *PermissionUpdate {
	pu.mutation.SetLastUpdateDate(t)
	return pu
}

// SetMarkAsDeleteDate sets the "mark_as_delete_date" field.
func (pu *PermissionUpdate) SetMarkAsDeleteDate(t time.Time) *PermissionUpdate {
	pu.mutation.SetMarkAsDeleteDate(t)
	return pu
}

// SetNillableMarkAsDeleteDate sets the "mark_as_delete_date" field if the given value is not nil.
func (pu *PermissionUpdate) SetNillableMarkAsDeleteDate(t *time.Time) *PermissionUpdate {
	if t != nil {
		pu.SetMarkAsDeleteDate(*t)
	}
	return pu
}

// ClearMarkAsDeleteDate clears the value of the "mark_as_delete_date" field.
func (pu *PermissionUpdate) ClearMarkAsDeleteDate() *PermissionUpdate {
	pu.mutation.ClearMarkAsDeleteDate()
	return pu
}
...
func (pu *PermissionUpdate) defaults() {
	if _, ok := pu.mutation.LastUpdateDate(); !ok {
		v := permission.UpdateDefaultLastUpdateDate()
		pu.mutation.SetLastUpdateDate(v)
	}
}
...
func (pu *PermissionUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := pu.mutation.LastUpdateDate(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
			Column: permission.FieldLastUpdateDate,
		})
	}
	if value, ok := pu.mutation.MarkAsDeleteDate(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
			Column: permission.FieldMarkAsDeleteDate,
		})
	}
	if pu.mutation.MarkAsDeleteDateCleared() {
...
// SetLastUpdateDate sets the "last_update_date" field.
func (puo *PermissionUpdateOne) SetLastUpdateDate(t time.Time) *PermissionUpdateOne {
	puo.mutation.SetLastUpdateDate(t)
	return puo
}

// SetMarkAsDeleteDate sets the "mark_as_delete_date" field.
func (puo *PermissionUpdateOne) SetMarkAsDeleteDate(t time.Time) *PermissionUpdateOne {
	puo.mutation.SetMarkAsDeleteDate(t)
	return puo
}

// SetNillableMarkAsDeleteDate sets the "mark_as_delete_date" field if the given value is not nil.
func (puo *PermissionUpdateOne) SetNillableMarkAsDeleteDate(t *time.Time) *PermissionUpdateOne {
	if t != nil {
		puo.SetMarkAsDeleteDate(*t)
	}
	return puo
}

// ClearMarkAsDeleteDate clears the value of the "mark_as_delete_date" field.
func (puo *PermissionUpdateOne) ClearMarkAsDeleteDate() *PermissionUpdateOne {
	puo.mutation.ClearMarkAsDeleteDate()
	return puo
}
...
func (puo *PermissionUpdateOne) defaults() {
	if _, ok := puo.mutation.LastUpdateDate(); !ok {
		v := permission.UpdateDefaultLastUpdateDate()
		puo.mutation.SetLastUpdateDate(v)
	}
}
...
func (puo *PermissionUpdateOne) sqlSave(ctx context.Context) (_node *Permission, err error) {
	...
	if value, ok := puo.mutation.LastUpdateDate(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
			Column: permission.FieldLastUpdateDate,
	...
	if value, ok := puo.mutation.MarkAsDeleteDate(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
			Column: permission.FieldMarkAsDeleteDate,
	...
	if puo.mutation.MarkAsDeleteDateCleared() {
		_spec.Fields.Clear = append(_spec.Fields.Clear, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Column: permission.FieldMarkAsDeleteDate,
		})
